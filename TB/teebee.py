...
def main(argv):
	...
	try:
		...
		print 'teebee.py -p <period length> -c <currency pair> -n <period of moving average>'
		sys.exit(2)
	...
	for opt, arg in opts:
		if opt == '-h':
			...
			if (int(arg) in [300,900,1800,7200,14400,86400]):
				...
				print 'Binance requires periods in 300,900,1800,7200,14400, or 86400 second increments'
				sys.exit(2)
